...
export default function BlogPage() {
  ...
  useEffect(() => {
    ...
    const desc =
      'Read the latest real estate trends, tips, and insights to help you buy, rent, or invest smarter.'
    ...
    const keywordsStr =
      'real estate blog, property tips, buying guide, renting guide, investment insights'
