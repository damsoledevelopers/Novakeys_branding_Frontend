...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    if (seo.metaTitle || pageContent.title) {
      document.title = seo.metaTitle || `${pageContent.title} | Real Estate`
    }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                {pageContent?.parsedContent?.title || pageContent?.title || 'About Us'}
              </h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-4">
                    We are a leading real estate platform that combines cutting-edge technology with personalized service to help you find your perfect property.
                  </p>
                  <p className="text-lg text-gray-600 mb-4">
                  ...
                  <p className="text-lg text-gray-600">
                    Whether you're looking to buy, rent, or invest in real estate, we provide the tools, expertise, and support you need to make informed decisions.
                  </p>
                </div>
