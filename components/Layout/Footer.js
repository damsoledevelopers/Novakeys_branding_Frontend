              ...
              <div className="flex items-center mb-6">
                <div className="ml-0">
                  <span className="text-2xl font-bold bg-gradient-to-r from-gold-400 to-gold-500 bg-clip-text text-transparent">
                    {footerData?.companyName || 'Real Estate'}
                  </span>
                  <p className="text-sm text-gray-400">{footerData?.companyTagline || 'Your property partner'}</p>
                </div>
              </div>
                ...
                <ul className="space-y-3">
                  ...
                  {!footerData && (
                    <>
                      ...
                      <li className="flex items-start text-gray-400">
                        <Mail className="h-5 w-5 mr-3 mt-0.5 flex-shrink-0 text-gold-400" />
                        <a href="mailto:info@example.com" className="hover:text-gold-400 transition-colors">
                          info@example.com
                        </a>
                      </li>
                      <li className="flex items-start text-gray-400">
